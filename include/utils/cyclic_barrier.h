...
#ifndef GROUTE_INCLUDE_UTILS_CYCLIC_BARRIER_H_
#define GROUTE_INCLUDE_UTILS_CYCLIC_BARRIER_H_
...
class CyclicBarrier {
 public:
  ...
  void Await() {
    ...
    // "spurious wakeup" means this thread could wake up even if no one called
    // m_condition.notify!
...
#endif  // GROUTE_INCLUDE_UTILS_CYCLIC_BARRIER_H_
